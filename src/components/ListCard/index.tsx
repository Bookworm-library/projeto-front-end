    ...
    >
      <Flex align={"start"} p="10px" >
        ...
        <Box p="0px 15px" color={"white"} overflow="hidden">
          ...
          <Text as="span" fontSize={{base:"12px",lg:"16px"}} maxW={"90px"} noOfLines={[1, 2, 3]}>
            {element.volumeInfo.title}
          </Text>
          <Heading as="h3" fontSize={{base:"16px",lg:"20px"}} marginTop="10px">
            Autor:
          </Heading>
          <Text as="span"  fontSize={{base:"12px",lg:"16px"}} noOfLines={[1]}>
